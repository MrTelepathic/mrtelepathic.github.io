...
export const About = () => {
  ...
  return (
    <>
      ...
      >
        <AboutContainer>
          <AboutTitle>About TP TAP</AboutTitle>
          <AboutText>
            <b>Welcome to TP TAP!</b> This is a simple yet addictive
          ...
          <AboutText>
            <b>TP TAP is a Progressive Web App. </b>
          ...
          <AboutText>
            Made with 🧡 by{" "}
            <AboutLink href="https://github.com/MrTelepathic" target="_blank">
              MrTelepathic
            </AboutLink>{" "}
            using:{" "}
          ...
          <Stack spacing={2} direction="row">
            <Button
              href="https://github.com/Mrtelepathic"
              target="_blank"
              variant="outlined"
              style={{
                fontSize: ".9rem",
